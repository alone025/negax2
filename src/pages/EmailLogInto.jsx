      ...
      <main className="w-full pt-16 sm:pt-11 md:pt-14 container min-h-[70vh] flex flex-col">
        ...
        <div className="btn">
          <button
            ...
            className="mt-20 w-full rounded-md flex  cursor-pointer items-center justify-center gap-4 py-2 shadow-md text-[#fff] bg-[#634F9E] duration-300"
          >
          ...
          {errors !== "" && (
            <p className="text-center font-mulish text-red-600 text-base mt-1">
              {errors}
            </p>
          )}
          <Link
