...
const Blog = () => {
    ...
    const [dote, setDote] = useState(false); // State for dropdown
    ...
    const cardData = [
        {
            img: img1,
            text: "Пророк (ﷺ) сказал: У двух любящих сердец, наилучший итог - это брак.",
        },
        {
            img: img1,
            text: "Брак является защитой для верующих.",
        },
        {
            img: img1,
            text: "Любовь и доброта в браке вознаграждаются Аллахом.",
        },
    ];
    ...
    return (
        <div className="container pt-[68px]">
            <header className="absolute container top-5 flex justify-between items-center w-full">
                ...
                <div className="cursor-pointer">
                    <p
                        ...
                        className="rgb-text text-base font-mulish font-bold"
                    >
                        Категории
                    </p>
                    {dote && (
                        <div className="absolute z-50 cursor-pointer right-0 top-7 w-fit bg-white rounded-md shadow-lg">
                            <button
                                onClick={toggleDropdown}
                                className="w-full font-mulish z-50 px-4 py-2 text-left text-gray-700 hover:bg-blue-500 hover:text-white rounded-t-md"
                            >
                                Категории
                            </button>
                        </div>
            ...
            {dote && (
                <div onClick={toggleDropdown} className="fixed inset-0 z-40" />
            )}
        ...
        <div className="carde mb-6 lg:mb-8">
            ...
            <div className="txt border-b border-l border-r border-solid border-[#00000020] rounded-b px-5 pt-3 pb-2">
                ...
                <div className="btm-cont mt-4 flex flex-row justify-between">
                    <p
                        onClick={() => window.open("/blog/asd", "_current")}
                        className="rgb-text cursor-pointer text-xs font-normal font-mulish"
                    >
                        читать далее
                    </p>
