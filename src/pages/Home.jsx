...
const Home = () => {
  ...
  return (
    <div className="flex flex-col items-center pt-16 px-4 min-h-screen   relative">
      ...
      <div
        onClick={handleLogin}
        className="cursor-pointer flex items-center justify-center bg-blue-700 rounded-md text-white px-4 py-2 absolute right-20"
      >
        login
      </div>
      ...
      <section className="border shadow h-[400px] w-full container p-5 rounded-xl">
        ...
        <div className="flex flex-col mt-3 gap-1">
          ...
          <p className=" text-[10px] text-white bg-[#6A59A7] w-20 flex items-center justify-center">
            Разведен(а)
          </p>
          <p className="text-sm">Семейное положение:</p>
          <p className=" text-[10px] text-white bg-[#6A59A7] w-4 flex items-center justify-center">
            7
          </p>
        </div>
      </section>
