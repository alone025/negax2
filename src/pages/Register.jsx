  ...
  <defs>
    <linearGradient id="paint0_linear_304_625" x1="11.3802" y1="-0.822533" x2="21.5058" y2="0.847326" gradientUnits="userSpaceOnUse">
      ...
      <stop offset="1" stopColor="#EDABC6"/>
        ...
        <main className="w-full pt-24 md:pt-12 container min-h-[70vh] gap-20 flex flex-col items-center justify-evenly">
              <div  className="flex flex-col gap-3">
                <p className="text-[#ACACAC] text-xl font-mulish font-normal text-center leading-6">Добро пожаловать в </p>
                <h1 className="rgb-text font-pro-monument font-normal text-[42px] text-center leading-[47px]">NIKAH.SPACE</h1>
              ...
              <h1 className="text-center rgb-text font-mulish text-[34px] leading-[42px] font-semibold mb-6">Регистрация</h1>
                ...
                <MdPhoneIphone className="text-[28px]" /><p className="font-poppins font-semibold text-sm md:text-lg">по номеру телефона</p>
                </button>
                ...
                <button className="">
                <p className="font-poppins font-semibold text-sm md:text-lg">Вход</p>
                </button>
                </Link>
